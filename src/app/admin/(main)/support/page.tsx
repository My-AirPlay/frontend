...
import { Headphone, Notepad2 } from 'iconsax-react';
...
const Help: React.FC = () => {
    ...
    const recentTicket = {
        id: 1234,
        user: 'Nina Dobrev',
        submittedDate: '28th Feb, 2025',
        subject: 'Music Upload',
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1350px] items-start">
                ...
                <div className="bg-[#1B2128] rounded-lg p-6 md:max-lg:col-span-2">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="max-md:text-sm font-medium">{recentTicket.user}</p>
                        </div>

                        <div>
                            <p className="text-xs md:text-sm text-white/60">Submitted</p>
                            <p className="max-md:text-sm font-medium">{recentTicket.submittedDate}</p>
                        </div>

                        <div>
                            <p className="text-xs md:text-sm text-white/60">Subject</p>
                            <p className="max-md:text-sm font-medium">{recentTicket.subject}</p>
                        </div>

                        <div>
                            <p className="text-xs md:text-sm text-white/60">Ticket Issue</p>
                            <p className="max-md:text-sm font-medium">{recentTicket.issue}</p>
                        </div>
