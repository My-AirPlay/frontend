					...
					<div className="h-64">
						<ResponsiveContainer width="100%" height="100%">
							<LineChart data={revenueData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
								...
								<YAxis stroke="#8E9196" />
								<Tooltip contentStyle={{ backgroundColor: '#1A1F2C', border: '1px solid #333' }} labelStyle={{ color: '#fff' }} />
								<Line type="monotone" dataKey="current" stroke="#FF5500" strokeWidth={2} dot={{ r: 3 }} activeDot={{ r: 5 }} />
								<Line type="monotone" dataKey="previous" stroke="#8E9196" strokeWidth={2} dot={{ r: 3 }} activeDot={{ r: 5 }} />
							</LineChart>
						</ResponsiveContainer>
					</div>
