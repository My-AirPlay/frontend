...
const Sales: React.FC = () => {
	...
	const [createdArtist, setCreatedArtist] = useState<createdArtistProp>({});
	...
	const [matchedArtists, setMatchedArtists] = useState<MatchedArtist[]>(placeholderParseData?.data?.filter(x => x?.userId) || []);

	const [unmatchedArtists, setUnmatchedArtists] = useState<MatchedArtist[]>(placeholderParseData?.data?.filter(x => !x?.userId) || []);
