...
const AuthActions = ({ btnText, isDisabled, isBusy }: AuthActionsProps) => {
	return (
		<div className="flex items-center justify-center gap-2 mt-8">
			<Button className="bg-transparent w-full max-w-icon-btn size-12 rounded-full flex items-center justify-center shadow-none border border-custom-icon-btn-border p-2" size="lg" type="button" disabled>
