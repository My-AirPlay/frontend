		...
		<div>
			...
			<Tabs defaultValue="general" className="w-full">
				<TabsList className="w-full bg-transparent border-b border-gray-800 justify-start space-x-6 rounded-none h-auto pb-2">
					<TabsTrigger value="general" className="px-0 py-2 data-[state=active]:border-b-2 data-[state=active]:border-[#FF6B00] data-[state=active]:text-white rounded-none bg-transparent text-gray-400 data-[state=active]:shadow-none">
						General Enquiries
					</TabsTrigger>
					...
					<TabsTrigger value="contract" className="px-0 py-2 data-[state=active]:border-b-2 data-[state=active]:border-[#FF6B00] data-[state=active]:text-white rounded-none bg-transparent text-gray-400 data-[state=active]:shadow-none">
						Contract Management
					</TabsTrigger>
				...
				<TabsContent value="general" className="mt-6">
					...
					{[1, 2, 3, 4].map(item => (
						<div key={`general-${item}`} className="mb-4">
							<div className="flex justify-between items-center py-3 cursor-pointer" onClick={() => toggleItem(`general-${item}`)}>
							...
							{expandedItems[`general-${item}`] && <div className="py-3 text-sm text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</div>}
				...
				<TabsContent value="account" className="mt-6">
					...
					{[1, 2, 3, 4].map(item => (
						<div key={`account-${item}`} className="mb-4">
							<div className="flex justify-between items-center py-3 cursor-pointer" onClick={() => toggleItem(`account-${item}`)}>
								<h4 className="font-medium">Lorem ipsum dolor sit amet</h4>
								{expandedItems[`account-${item}`] ? <Minus className="h-4 w-4" /> : <Plus className="h-4 w-4" />}
							</div>

							{expandedItems[`account-${item}`] && <div className="py-3 text-sm text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</div>}
							<div className="border-b border-gray-800"></div>
						</div>
					))}
				</TabsContent>
				...
				<TabsContent value="payment" className="mt-6">
					...
					{[1, 2, 3, 4].map(item => (
						<div key={`payment-${item}`} className="mb-4">
							<div className="flex justify-between items-center py-3 cursor-pointer" onClick={() => toggleItem(`payment-${item}`)}>
								<h4 className="font-medium">Lorem ipsum dolor sit amet</h4>
								{expandedItems[`payment-${item}`] ? <Minus className="h-4 w-4" /> : <Plus className="h-4 w-4" />}
							</div>

							{expandedItems[`payment-${item}`] && <div className="py-3 text-sm text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</div>}
							<div className="border-b border-gray-800"></div>
						</div>
					))}
				</TabsContent>
