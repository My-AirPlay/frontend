...
const Step3AlbumCoverUpload = () => {
    const { setCoverArt, setCurrentStep, coverArtId, getCoverArtFile, initializeDB, isDBInitialized } =
        useAlbumUploadStore()
    ...
    return (
        <div className="w-[80vw] sm:w-[55vw] max-w-[600px] md:max-w-3xl mx-auto">
            <section className="mb-8 grid lg:grid-cols-2 gap-8 lg:items-stretch">
                <label
                    className={cn(
                        "border-2 border-dashed border-primary rounded-xl flex flex-col items-center justify-center max-h-[300px] aspect-square p-4",
