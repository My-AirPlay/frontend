...
const Step3MediaCoverUpload = () => {
  const { setCoverArt, setCurrentStep, coverArtId, mediaInfo, getCoverArtFile, initializeDB, isDBInitialized } =
    useMediaUploadStore()
    ...
    <div className="w-[82vw] sm:w-[55vw] max-w-[500px] md:max-w-3xl mx-auto">
      <section className="mb-8 grid lg:grid-cols-2 gap-8 lg:items-stretch">
        <div className="flex flex-col gap-2">
          <label
            className={cn(
              "flex-1 border-2 border-dashed border-primary rounded-xl flex flex-col items-center justify-center max-md:w-[250px] md:max-h-[300px] p-3 aspect-square",
