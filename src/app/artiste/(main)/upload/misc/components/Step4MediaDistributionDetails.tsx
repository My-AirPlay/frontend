          ...
          <article className="p-4 bg-background/70 rounded-xl">
            ...
            <div className="space-y-5 text-left max-lg:text-sm">
              <div>
                ...
                You should set the release date at least 21 days in the future, This gives you enough time to announce
                the release to fans, share pre-save links, and pitch to DSPs for playlist inclusion. It also allows time
                to make any changes requested by the approval team
              </div>
              <div>
                <span className="font-medium text-primary">Release Time: </span>
                Your release will be available starting at 12am for each territory. Most stores allow you to select the
                availability time settings for your release
              </div>
              <div>
