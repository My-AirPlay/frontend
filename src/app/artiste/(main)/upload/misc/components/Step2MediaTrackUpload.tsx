...
export default function Step2MediaTrackUpload() {
  ...
  // Initialize IndexedDB and load media file if exists
  useEffect(() => {
  ...
  return (
    <div className="w-[82vw] sm:w-[55vw] max-w-[500px] md:max-w-3xl mx-auto ">
      <section className="mb-8 grid lg:grid-cols-2 gap-8 lg:items-stretch">
        <label
          className={cn(
            "border-2 border-dashed border-primary rounded-xl flex flex-col items-center justify-center",
        ...
        >
          ...
          <p className="text-white/30 mb-6 text-xs max-w-[30ch]">
            Drag and drop your audio file here, or click the button below
          </p>
        </label>
        <div className="flex flex-col items-start justify-center">
          ...
          <Button
            ...
            size="lg"
            className="bg-primary hover:bg-primary text-white rounded-full px-8 mt-2.5"
          >
            Browse
          </Button>
        </div>
