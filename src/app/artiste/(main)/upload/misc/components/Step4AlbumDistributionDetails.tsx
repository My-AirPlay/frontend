...
export default function Step4AlbumDistributionDetails() {
	const { streamingPlatforms: selectedPlatforms, togglePlatform, setCurrentStep, albumInfo, coverArtId, updateAlbumInfo, getCoverArtFile, isDBInitialized, initializeDB } = useAlbumUploadStore();
