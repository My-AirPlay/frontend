...
const AudioCard = ({ audio }: { audio: TArtistMedia }) => {
	...
	return (
		<article className="relative flex flex-col gap-2.5 rounded-xl cursor-pointer p-1 border-[0.6px]">
			...
			<CustomAlertDialog variant={'warning'} open={isConfirmDeleteModalOpen} onOpenChange={setConfirmDeleteModalState} title={'Confirm Delete'} description={'Are you sure you want to delete this audio track? This action cannot be undone.'} actionLabel={'Go ahead, delete'} cancelLabel="Cancel" onAction={handleDelete} onCancel={closeConfirmDeleteModal} showCancel={true} showAction={true} isPerformingAction={isDeletingMedia} />
		</article>
	);
};
