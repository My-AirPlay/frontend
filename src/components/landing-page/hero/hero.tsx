				...
				<div className="flex items-center justify-between">
					<div>
						<h1 className="font-plus-jakarta-sans font-bold text-[62px] md:max-w-[422px] text-white mb-12 flex flex-col">
							Empower your Music...
							<span className="max-w-[295px] md:hidden block text-white font-plus-jakarta-sans font-bold text-[62px]">own your journey</span>
						</h1>

						<div className="flex items-center gap-4 mb-14">
							<DemoRequestButton />
							<Button className=" hover:bg-custom-primary text-white bg-custom-primary font-plus-jakarta-sans font-bold text-base border max-w-[176px] w-full border-custom-primary rounded-full">Get Started</Button>
						</div>
					...
					<div className="md:block hidden">
						...
						<h2 className="max-w-[295px] text-white font-plus-jakarta-sans font-bold text-[62px]">own your journey</h2>
					</div>
				</div>
			</article>
			<div
