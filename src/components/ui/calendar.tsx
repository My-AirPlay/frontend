  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: 'flex justify-center pt-1 relative items-center min-w-[300px] w-full',
          ...
          return (
            ...
            >
              ...
              <SelectContent position="popper">
                {options.map((option: React.ReactElement<React.HTMLProps<HTMLOptionElement>>, id: number) => (
                  <SelectItem
