...
const FormLabel = React.forwardRef<React.ElementRef<typeof LabelPrimitive.Root>, React.ComponentPropsWithoutRef<typeof LabelPrimitive.Root> & { info?: string }>(({ className, info, ...props }, ref) => {
...
const FormMessage = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, children, ...props }, ref) => {
	...
	return (
		<p ref={ref} id={formMessageId} className={cn('!text-[0.75rem] font-medium text-destructive px-4 py-1 rounded-md bg-red-100', className)} {...props}>
			{body}
		</p>
	);
});
