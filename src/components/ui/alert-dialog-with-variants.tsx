...
const AlertDialogWithVariantsOverlay = React.forwardRef<
...
interface AlertDialogWithVariantsContentProps 
  extends React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content>,
    VariantProps<typeof alertDialogWithVariantsVariants> {}

const AlertDialogWithVariantsContent = React.forwardRef<
...
// Header component
const AlertDialogWithVariantsHeader = ({
  className,
  ...props
...
// Footer component
const AlertDialogWithVariantsFooter = ({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => (
  <div
...
// Title with variants
interface AlertDialogWithVariantsTitleProps 
  extends React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Title>,
    VariantProps<typeof alertDialogWithVariantsTitleVariants> {}

const AlertDialogWithVariantsTitle = React.forwardRef<
  React.ElementRef<typeof AlertDialogPrimitive.Title>,
  AlertDialogWithVariantsTitleProps
>(({ className, variant, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn(alertDialogWithVariantsTitleVariants({ variant }), className)}
    {...props}
  />
))
...
const AlertDialogWithVariantsDescription = React.forwardRef<
...
interface AlertDialogWithVariantsActionProps 
  extends React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action>,
    VariantProps<typeof alertDialogWithVariantsActionVariants> {}

const AlertDialogWithVariantsAction = React.forwardRef<
  React.ElementRef<typeof AlertDialogPrimitive.Action>,
  AlertDialogWithVariantsActionProps
>(({ className, variant, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(alertDialogWithVariantsActionVariants({ variant }), className)}
    {...props}
  />
))
...
// Cancel button
const AlertDialogWithVariantsCancel = React.forwardRef<
