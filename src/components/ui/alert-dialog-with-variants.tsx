...
const CustomAlertDialog = ({ variant = 'default', open, onOpenChange, title, description, actionLabel = 'Confirm', cancelLabel = 'Cancel', onAction, onCancel, showCancel = true, showAction = true, isPerformingAction = false }: CustomAlertDialogProps) => {
	return (
